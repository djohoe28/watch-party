...
export const RoomUserContextProvider = ({ children, usersRef, authContext: auth }: { children: ReactNode, usersRef: UsersCollectionReference, authContext: AsyncContext<User> }) => {
